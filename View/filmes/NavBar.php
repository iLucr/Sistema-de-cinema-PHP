	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active descer"><a href="../adm/index.php" class="nav-link">Home</a></li>
	          <li class="nav-item descer"><a href="#" class="nav-link">Ingressos</a></li>
                  <li class="nav-item descer"><a href="#" class="nav-link">Filmes</a></li>
                  <li class="nav-item descer"><a href="../adm/Cadastrar.php" class="nav-link">Cadastrar ADM</a></li>
                  <li class="nav-item descer"><a href="../filmes/index.php" class="nav-link">Cadastro de Filmes</a></li>
											<?php
